...
```{r Intro, child = '../Sections/08_Introduction.Rmd', eval = T}
```
...
```{r chapter_two, child = '~/GitHub/FishForVisa/Scripts/Manuscript_Draft.Rmd', eval = T}
```
...
```{r chapter_three, child = '~/GitHub/TransEmergence/Scripts/Manuscript.Rmd', eval = T}
```
...
```{r chapter_four, child = '~/GitHub/OC_Transboundary/Ecol/Manuscript_Draft.Rmd', eval = T}
```
...
```{r appendix_a, child = '~/GitHub/FishForVisa/Scripts/supplements.Rmd', eval = T}
```
...
```{r appendix_b, child = '~/GitHub/TransEmergence/Scripts/Supplements.Rmd', eval = T}
```
...
```{r appendix_c, child = '~/GitHub/OC_Transboundary/Ecol/Supplements.Rmd', eval = T}
```
