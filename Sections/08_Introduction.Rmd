...
```{r figureTitle, eval = T, echo = T, fig.width = 5, fig.height = 4, echo=FALSE, fig.cap="This is the long caption of my fifure that will apear in the main text.", fig.scap = "This is the short title for the figure list", out.extra=''}

# Call the image
img <- readPNG("../Images/ubc_logo.png")
