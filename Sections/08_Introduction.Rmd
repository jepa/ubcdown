...
(ref:introfig1-cap) This caption was written with an in-text reference. See how I can use citations like this and **special** *characters* _!?@#, which normally would not be possible.
